 ...
 */
public class AdapterListTubuyaki extends ArrayAdapter<Tubuyaki> {
     ...
     */
    public AdapterListTubuyaki(Context context, int resource, List<Tubuyaki> objects) {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            idTextView = (TextView) view.findViewById(R.id.list_tubuyaki_id_txv);
            commentTextView = (TextView) view.findViewById(R.id.list_tubuyaki_comment_txv);
        }
    }
}